...
##vet_county_DMA_stats <- transform(vet_county_DMA_stats, TVDMA = gsub("Syracuse, NY*", "Syracuse, NY", TVDMA))
## Utica, Ny also has this problem/issue

vet_county_DMA_stats2 <- transform(vet_county_DMA_stats, TVDMA = gsub("Lufkin", "", TVDMA))
vet_county_DMA_stats2 <- transform(vet_county_DMA_stats2, TVDMA = gsub("Nacogdoches", "", TVDMA))
vet_county_DMA_stats2 <- transform(vet_county_DMA_stats2, TVDMA = gsub("[()&]", "", TVDMA))
vet_county_DMA_stats2 <- transform(vet_county_DMA_stats2, TVDMA = gsub("[*]", "", TVDMA))

vet_county_DMA_final <- vet_county_DMA_stats2 %>% select(TVDMA, percent_vet)%>%  group_by(TVDMA) %>% distinct() %>% view()
vet_county_DMA_final <- mutate(vet_county_DMA_final, across(where(is.character), .fns = toupper)) %>% view()




vet_county_DMA_final %>% write_xlsx(here("data", "vet_county_DMA_final.xlsx"))
